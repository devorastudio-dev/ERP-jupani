          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {whatsappUrl && (
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center rounded-full bg-[#3a231c] px-5 py-3 text-sm font-semibold !text-white transition hover:-translate-y-0.5 hover:bg-[#5a362c] hover:!text-white"
              >
                Abrir WhatsApp
              </Link>
            )}
